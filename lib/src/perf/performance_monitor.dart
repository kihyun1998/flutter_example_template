...
/// .addTimingsCallback`, which is a feature and not this field.
class PerformanceMonitor extends StatelessWidget {
  final PerformanceMetrics metrics;

  const PerformanceMonitor({super.key, required this.metrics});
        ...
        children: [
          ...
          if (metrics.dataGenerationTimeMs != null)
            _buildMetricRow(
              ...
              color: Colors.green,
              subtitle: _formatRate(
                metrics.rowCount,
                metrics.dataGenerationTimeMs!,
              ),
            ),
...
class PerformanceIndicator extends StatelessWidget {
  ...
  const PerformanceIndicator({super.key, required this.metrics});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(_getPerformanceIcon(), size: 14, color: Colors.white),
